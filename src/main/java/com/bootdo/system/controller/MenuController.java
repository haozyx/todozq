...
public class MenuController extends BaseController {
	...
	String treemenu(Model model) {
		return prefix+"/treemenu";
	}
	...
	@GetMapping("/listmenu")
	@RequiresPermissions("sys:menu:menu")
	public PageUtils listMenu(@RequestParam Map<String, Object> params){
		//查询列表数据
        Query query = new Query(params);
		List<MenuDO> svnList = menuService.list(query);
